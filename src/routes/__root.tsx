...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://www.estudodemercadomax.com.br/og-image.png" },
      ...
      { name: "twitter:image", content: "https://www.estudodemercadomax.com.br/og-image.png" },
